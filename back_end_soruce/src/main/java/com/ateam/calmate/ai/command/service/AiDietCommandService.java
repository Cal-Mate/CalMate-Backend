...
public class AiDietCommandService {
    ...
    public AiResponseDTO getDietAndSave(RequestDietDTO request) {
        ...
        // Fast API로 통신
        String fastApiUrl = "http://http://fourth-project-ai/recommend/api/v1/diet/recommend";
    ...
    public AiExerciseResponseDTO getExercise(RequestExerciseDTO request) {
        ...
        // Fast API로 통신
        String fastApiUrl = "http://fourth-project-ai/recommend/api/v1/exercise/recommend";
